...
--  作った人：Xen-Shuto
--  更新履歴
--    00.00.006：2026/01/15：4.*.*に対応（以前は少し問題あったけど問題無かった）
--                           雑に英語に対応
...
　・画像サイズは400x400 （最大で左右は560pxくらいまでいける。）
...
　　　　　　また、ポートレートの一覧が表示されているか
　　　　⇒表示されない場合、ポートレート定義の記述と画像ファイル名が一致していないものと思われる
　　　　　見直してください。
